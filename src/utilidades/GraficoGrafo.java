...
public class GraficoGrafo extends JFrame {
    ...
    public GraficoGrafo(int[][] matrizAdyacencia) {
    ...
    public void paint(Graphics g) {
        ...
        int numVertices = matrizAdyacencia.length - 1;
        ...
        for (int i = 1; i <= numVertices; i++) {
            ...
            if (matrizAdyacencia[i][i] != 0) {
                ...
                g.drawArc(x - 20, y - 20, 40, 40, 45, 270); // Dibujar un arco como bucle
                // Mostrar el peso en un cuadro para el bucle
                String pesoBucle = String.valueOf(matrizAdyacencia[i][i]);
                int posX = x - cuadroSize / 2;
                int posY = y - cuadroSize - 10; // Posición ligeramente más arriba del vértice // jajjas tan bonito :)
